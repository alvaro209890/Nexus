...
MAX_PDF_UPLOAD_BYTES = int(os.getenv("MAX_PDF_UPLOAD_BYTES", str(100 * 1024 * 1024)))
MAX_ZIP_UPLOAD_BYTES = int(os.getenv("MAX_ZIP_UPLOAD_BYTES", str(2 * 1024 * 1024 * 1024)))
...
DEFAULT_STORAGE_LIMIT_BYTES = int(os.getenv("NEXUS_DEFAULT_STORAGE_LIMIT_BYTES", str(20 * 1024 * 1024 * 1024)))
